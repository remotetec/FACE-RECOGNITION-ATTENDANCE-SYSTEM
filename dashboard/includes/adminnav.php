 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Face-Recognition-Attendance-System</a>
            </div>
...
<div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="index.php" class="active"><i class="fa fa-fw fa-dashboard"></i> View All Students</a>
                    </li>

                    <li>
                        <a href="./users.php" class="active"><i class="fa fa-fw fa-dashboard"></i>Add Students</a>
                    </li>
                 ...
                 <?php if($_SESSION['role'] == 'admin') {
                  ...
                  <!-- <li>
                        ...
                        <ul id="user" class="collapse">
                            <li>
                                <a href="./users.php">View All Students</a>
                                <a href="../signup.php">Add Students</a>
                            </li>
