...
<?php
    if (isset($_POST['upload'])) {
        ...
        if(move_uploaded_file($_FILES['file']['tmp_name'], $folder.$notefile)) {
            $query = "INSERT INTO users(file) VALUES ('$notefile')";
...
?>
	...
	<div class="form-group">
		<label for="post_title">Student Name</label>
		<input type="text" name="title" class="form-control" placeholder="Eg: Php Tutorial File"  value = "">
	</div>

	<div class="form-group">
		<label for="post_tags">Roll No.</label>
		<input type="text" name="description" class="form-control" placeholder="Eg: Php Tutorial File includes basic php programming ...." value="">
	</div>
